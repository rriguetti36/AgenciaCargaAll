...
GO
IF COL_LENGTH(N'dbo.Quotations', N'commodityCatalogId') IS NULL ALTER TABLE dbo.Quotations ADD commodityCatalogId INT NULL;
GO
...
GO
IF COL_LENGTH(N'dbo.Quotations', N'frequency') IS NULL ALTER TABLE dbo.Quotations ADD frequency NVARCHAR(120) NULL;
GO
...
BEGIN
    ALTER TABLE dbo.Quotations ADD CONSTRAINT FK_Quotations_CommodityCatalog FOREIGN KEY (commodityCatalogId) REFERENCES dbo.CommodityCatalog(id);
END
GO
...
GO
IF COL_LENGTH(N'dbo.QuotationCharges', N'quantity') IS NULL ALTER TABLE dbo.QuotationCharges ADD quantity DECIMAL(18,3) NOT NULL CONSTRAINT DF_QuotationCharges_quantity DEFAULT (1);
GO
IF COL_LENGTH(N'dbo.QuotationCharges', N'igvRate') IS NULL ALTER TABLE dbo.QuotationCharges ADD igvRate DECIMAL(9,4) NOT NULL CONSTRAINT DF_QuotationCharges_igvRate DEFAULT (0);
GO
IF COL_LENGTH(N'dbo.QuotationCharges', N'igvAmount') IS NULL ALTER TABLE dbo.QuotationCharges ADD igvAmount DECIMAL(18,2) NOT NULL CONSTRAINT DF_QuotationCharges_igvAmount DEFAULT (0);
GO
...
SET section = N'gastos_destino',
    ...
    igvRate = 0.18,
    igvAmount = ROUND(saleAmount * quantity * 0.18, 2)
